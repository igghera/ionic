...
.controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
  ...
  $scope.projectsList = $firebase(new Firebase("https://ionic-first-app.firebaseio.com/projects"));
  $scope.user = $firebase(new Firebase("https://ionic-first-app.firebaseio.com/Users/John"));
